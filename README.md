...
SECRET_KEY=0c29de079a5707e2ed58447f84bed7eb745584b65eaf2d4c0fb987fb190f4753
...
Response:
{"status": "success", "public_key": "base64_encoded_public_key", "private_key": "base64_encoded_private_key"}

POST /encrypt
Encrypts a message using a public key.

Request:
{"message": "Hello, World!", "public_key": "base64_encoded_public_key"}

Response:
{"status": "success", "ciphertext": "base64_encoded_ciphertext"}

POST /decrypt
Decrypts a ciphertext using a private key.

Request:
{"ciphertext": "base64_encoded_ciphertext", "private_key": "base64_encoded_private_key"}

Response:
{"status": "success", "plaintext": "Decrypted message"}
...
Import errors - Ensure you're using the correct Python environment and all dependencies are installed

Connection refused - Check if the port (5000) is available and the Flask app is running
